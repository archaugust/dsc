...
function resizeRelativeDivs() {
	$("#banner figure").height($(".banner-image").height());
	$(".sub-intro").height($(".sub-intro-image").height());
	$(".subscribe").height($(".subscribe-image").height());
}

function mobileTap(){
    $('figure.instagram').click(function(){
...
$('#Form_SubscribeForm').submit(function(event) {
    ...
    $.ajax({
        ...
        success: function (data) {
            $('#msgDiv').html(data);
           	$('#recaptchaButton').html('Signed Up').attr('disabled','true');
        }
    })
